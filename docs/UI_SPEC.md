...
- Sidebar: chats ficam em lista simples, filtrável por texto, provider e modelo. Organização real continua sendo feita por seção/perfil para evitar ambiguidade entre "pasta" visual e isolamento de dados.
