...
When an attachment is removed, My Computer deletes the saved runtime copy and redacts old message snapshots so the removed content is not sent in later prompts or included in backups.
